 ...
 * @param {string} args.account_id - The ad account ID to create the campaign for.
 * @param {string} args.name - The name of the campaign.
 * @param {string} [args.objective='OUTCOME_AWARENESS'] - The objective of the campaign.
 ...
 */
const executeFunction = async ({ account_id, name, objective = 'OUTCOME_AWARENESS', status = '', special_ad_categories = [] }) => {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          account_id: {
            type: 'string',
            description: 'The ad account ID to create the campaign for.'
          },
          name: {
            type: 'string',
