...
const Features = () => {
  ...
  const getColorClasses = (color: string) => {
    const colors = {
      ...
      yellow: 'text-yellow-500 bg-yellow-50 dark:bg-yellow-900/30 dark:text-yellow-400',
      purple: 'text-purple-500 bg-purple-50 dark:bg-purple-900/30 dark:text-purple-400',
      green: 'text-green-500 bg-green-50 dark:bg-green-900/30 dark:text-green-400',
      red: 'text-red-500 bg-red-50 dark:bg-red-900/30 dark:text-red-400',
      teal: 'text-teal-500 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400'
    };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 hover:shadow-xl transition-all duration-300"
              >
